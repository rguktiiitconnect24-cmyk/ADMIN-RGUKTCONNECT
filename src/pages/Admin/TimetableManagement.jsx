                                                    ...
                                                    >
                                                        {showMergeBtn && (
                                                            <div className="merge-popup-container absolute top-[-40px] left-1/2 transform -translate-x-1/2 bg-slate-800 text-white p-1 rounded shadow-xl flex gap-1 z-10 flex-row">
                                                                ...
                                                                <button className="merge-popup-btn cancel flex items-center justify-center bg-red-500 hover:bg-red-600 text-white w-6 h-6 rounded" onClick={(e) => { e.stopPropagation(); setSelectedCells([]); }}><X size={16} color="#ffffff" /></button>
                                                            </div>
                                                        )}
                                                        {showUnmergeBtn && (
                                                            <div className="merge-popup-container absolute top-[-40px] left-1/2 transform -translate-x-1/2 bg-slate-800 text-white p-1 rounded shadow-xl flex gap-1 z-10 flex-row">
